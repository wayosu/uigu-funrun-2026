...
@section('content')
    @if ($event)
        ...
        <div class="relative min-h-screen bg-fun-dark flex items-center justify-center overflow-hidden">
            ...
            {{-- Organic Shapes --}}
            <div class="absolute top-[-20%] left-[-10%] w-[50%] h-[50%] bg-gradient-to-br from-fun-green to-fun-teal rounded-full blur-[100px] opacity-20 animate-pulse"></div>
            <div class="absolute bottom-[-10%] right-[-5%] w-[40%] h-[40%] bg-gradient-to-tr from-fun-yellow to-fun-green rounded-full blur-[80px] opacity-20 animate-pulse" style="animation-delay: 2s;"></div>

             {{-- Hero Content --}}
            <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center">
                {{-- Logo with Glow --}}
                <div class="mb-12 relative group">
                    <div class="absolute inset-0 bg-fun-yellow blur-3xl opacity-20 group-hover:opacity-40 transition-opacity duration-500 rounded-full"></div>
                ...
                {{-- Main Date & Location --}}
                 <div class="flex flex-wrap justify-center gap-6 mb-8 text-sm md:text-base font-bold tracking-widest uppercase text-white/80">
                ...
                <a href="#categories"
                   class="group relative inline-flex items-center justify-center px-10 py-5 text-lg font-bold text-white transition-all duration-200 bg-transparent font-heading rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-fun-green">
                    <span class="absolute inset-0 w-full h-full -mt-1 rounded-full opacity-30 bg-gradient-to-r from-fun-green via-fun-teal to-fun-green"></span>
                    <span class="absolute inset-0 w-full h-full mt-1 rounded-full opacity-30 bg-gradient-to-r from-fun-green via-fun-teal to-fun-green"></span>
                    <span class="relative w-full h-full flex items-center bg-gradient-to-r from-fun-green to-fun-teal rounded-full inset-0 px-10 py-5 group-hover:scale-105 transition-transform duration-300 shadow-[0_0_20px_rgba(0,210,133,0.3)] hover:shadow-[0_0_40px_rgba(0,210,133,0.5)]">
                        DAFTAR SEKARANG
                        <svg class="w-5 h-5 ml-2 -mr-1 transition-transform group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
                    </span>
                </a>
            </div>
        ...
        <div id="categories" class="relative py-32 bg-gray-50 overflow-hidden">
             {{-- Fancy Background --}}
            <div class="absolute inset-0 bg-[url('data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iNDAiIGhlaWdodD0iNDAiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PGNpcmNsZSBjeD0iMSIgY3k9IjEiIHI9IjEiIGZpbGw9InJnYmEoMCwgMCwgMCwgMC4wNSkiLz48L3N2Zz4=')] bg-repeat opacity-50"></div>
            ...
            <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    @foreach ($event->raceCategories as $category)
                        <div class="group relative bg-white rounded-3xl p-1 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
                            {{-- Gradient Border Effect --}}
                            <div class="absolute inset-0 bg-gradient-to-br from-gray-100 to-gray-200 rounded-3xl -z-10 group-hover:from-fun-green group-hover:to-fun-teal transition-all duration-500"></div>

                            <div class="h-full bg-white rounded-[22px] overflow-hidden flex flex-col p-8 relative z-0">
                                {{-- Icon / Category Badge --}}
                                <div class="mb-6 flex items-center justify-between">
                                    <div class="w-14 h-14 rounded-2xl bg-fun-green/10 text-fun-green flex items-center justify-center group-hover:bg-fun-green group-hover:text-white transition-colors duration-300">
                                        <svg class="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z" />
                                        </svg>
                                    </div>
                                    <span class="px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider bg-gray-100 text-gray-600 group-hover:bg-fun-yellow group-hover:text-fun-dark transition-colors">{{ $category->distance }}</span>
                                </div>
                                ...
                                <div class="space-y-4 mb-8 flex-grow">
                                    ...
                                    <div class="pt-4 border-t border-gray-100">
                                        <div class="flex items-baseline text-gray-900">
                                            <span class="text-3xl font-black tracking-tight">Rp {{ number_format($category->price_individual, 0, ',', '.') }}</span>
                                        </div>
        ...
        <div id="about" class="py-24 bg-white relative overflow-hidden">
             <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <div class="relative">
                        <div class="absolute -top-10 -left-10 w-40 h-40 bg-fun-yellow rounded-full mix-blend-multiply filter blur-2xl opacity-30 animate-pulse"></div>
                        <div class="absolute -bottom-10 -right-10 w-40 h-40 bg-fun-teal rounded-full mix-blend-multiply filter blur-2xl opacity-30 animate-pulse"></div>
                        <img src="{{ asset('assets/bg-hero.jpeg') }}" alt="Runners" class="relative rounded-[2rem] shadow-2xl skew-y-3 transform hover:skew-y-0 transition-transform duration-700">
                    </div>
                    <div>
                        <h2 class="text-4xl font-black text-gray-900 mb-6 font-heading leading-tight">LEBIH DARI SEKADAR <br><span class="text-fun-green">LARI MINGGU PAGI</span></h2>
                        <p class="text-lg text-gray-600 mb-8 leading-relaxed">
                            Bergabunglah dengan ribuan pelari lainnya dalam event lari paling ditunggu tahun ini.
                            Rasakan atmosfer yang penuh semangat, rute yang menantang namun aman, dan perayaan gaya hidup sehat bersama komunitas.
                        </p>

                        <div class="space-y-6">
                            <div class="flex items-start">
                                <div class="flex-shrink-0 w-12 h-12 rounded-full bg-fun-green/10 flex items-center justify-center text-fun-green mt-1">
                                    <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                                </div>
                                <div class="ml-4">
                                    <h4 class="text-xl font-bold text-gray-900">Rute Steril & Aman</h4>
                                    <p class="text-gray-500">Keamanan pelari adalah prioritas utama kami dengan pengawalan medis.</p>
                                </div>
                            </div>
                             <div class="flex items-start">
                                <div class="flex-shrink-0 w-12 h-12 rounded-full bg-fun-teal/10 flex items-center justify-center text-fun-teal mt-1">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-gray-500">Desain medali unik dan jersey berkualitas tinggi untuk semua peserta.</p>
                                </div>
                            </div>
                        </div>
                    </div>
